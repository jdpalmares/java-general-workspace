...
// describing an edge between nodes  and .

// Output Format
// Do not print anything to stdout, as this is handled by locked stub code in the editor. 
// The three getResult() methods provided for you must return an integer denoting the  
// for that class' visitor (defined above). Note that the value returned by 
// ProductRedNodesVisitor's getResult method must be computed modulo .
...
public class AdvJavaClassManipVisitorProb {
