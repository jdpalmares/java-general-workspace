...
class ShortestPathPrioQ {
    ...
    // class constructor
    public ShortestPathPrioQ(int V) {
        this.V = V;
        dist = new int[V];
    ...
    public static void main(String arg[]) {
        ...
        ShortestPathPrioQ sppq = new ShortestPathPrioQ(V);
        sppq.algo_dijkstra(adj_list, source);
        ...
        for (int i = 0; i < sppq.dist.length; i++)
            System.out.println(source + " \t\t " + i + " \t\t " + sppq.dist[i]);
    }
}
